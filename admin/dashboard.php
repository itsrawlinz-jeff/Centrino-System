                    ...
                    <div class="col s12 m12 l4">
                        <div class="card stats-card">
                            <div class="card-content"style="background-color:black">
                                ...
                                <span class="card-title"style="color:white">Total Regd Employee</span>
...
?>
                        ...
                        <div class="card stats-card">
                            <div class="card-content"style="background-color:black">
                                ...
                                <span class="card-title" style="color:white">Listed Departments </span>
    <?php
...
?>                            
                                <span class="stats-counter"><span class="counter"style="color:white"><?php echo htmlentities($dptcount);?></span></span>
                            </div>
                    ...
                    <div class="col s12 m12 l4">
                        <div class="card stats-card">
                            <div class="card-content"style="background-color:black">
                                <span class="card-title"style="color:white">Listed leave Type</span>
                                    <?php
...
?>   
                                <span class="stats-counter"><span class="counter"style="color:white"><?php echo htmlentities($leavtypcount);?></span></span>
                        ...
                        <div class="col s12 m12 l12">
                            <div class="card invoices-card">
                                <div class="card-content" style="background-color:black">
                                    ...
                                    <span class="card-title"style="color:white">Latest Leave Applications</span>
