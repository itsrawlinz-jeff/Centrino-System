...
error:function (){}
  ...
  <?php include('includes/header.php');?>
   ...
   <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title"style="color:white">Add employee</div>
                    </div>
                                        ...
                                        <section>
                                            <div class="wizard-content">
                                                <div class="row">
                                                    <div class="col m6">
                                                        <div class="row">
     <?php if($error){?><div class="errorWrap"style="background-color:black"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
