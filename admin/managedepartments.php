    ...
    <body>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title"style="color:white">Manage Departments</div>
                    </div>
                    <div class="col s12 m12 l12">
                        <div class="card">
                            <div class="card-content"style="background-color:black">
                                <span class="card-title" style="color:#fff">Departments Info</span>
                                 <?php if($msg){?><div class="succWrap"style="background-color:black"><strong>SUCCESS</strong> : <?php echo htmlentities($msg); ?> </div><?php }?>
