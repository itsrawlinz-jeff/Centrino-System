...
.succWrap{
  ...
  <?php include('includes/header.php');?>
   ...
   <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title" style="color: white;">Update employee</div>
                    </div>
...
<label for="empcode"  style="color: white;">Employee Code</label>
...
<div class="input-field col s12">
<label for="phone"  style="color: white;">Mobile number</label>
